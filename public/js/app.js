...
// class TimersDashboardRouter extends React.Component {
//     render() {
//         return (
//             <HashRouter basename="/">
//                 <TimersDashboard />
...
class TimersDashboard extends React.Component {
    ...
    handleFormDelete = (timerId) => {
        const newTimers = 
        this.setState({
            timers: this.state.timers.reduce((newTimersList, timer) => {
                if(timer.id === timerId) {
                    return newTimersList;
                } else {
                    return newTimersList.concat(timer);
                }
            }, [])
        });
